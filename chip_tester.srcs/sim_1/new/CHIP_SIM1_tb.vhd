...
entity CHIP_SIM1_tb is
end CHIP_SIM1_tb;

architecture Behavioral of CHIP_SIM1_tb is
...
BTNU_process: process
    begin
        BTNU <= '0';
        wait for clk_5MHz_period*15;
        wait for clk_5MHz_period  * 20; -- *20 to let the clk_wiz start
        BTNU <= '1';
        wait for clk_5MHz_period*4;
        BTNU <= '0';
        wait for clk_5MHz_period*10;
        BTNU <= '1';
        wait for clk_5MHz_period*4;
        BTNU <= '0';
