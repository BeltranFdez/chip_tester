...
HD_PWD='C:/Users/beltf/Desktop/TFG_todo/Codigo/TFG/chip_tester/chip_tester.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CHIP_SYNTH_V1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CHIP_SYNTH_V1.tcl
