...
HD_PWD='C:/Users/beltf/Desktop/TFG_todo/Codigo/TFG/chip_tester/chip_tester.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CHIP_SYNTH_V1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CHIP_SYNTH_V1.tcl -notrace
